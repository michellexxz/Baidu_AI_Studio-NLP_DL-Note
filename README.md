...
| 03 | 基础 | 2021.06.09 | 周三 | [预训练语言模型及应用]() | [文本语义相似度计算](./ppt_notes/03_文本语义相似度计算.ipynb) | UNK | [Semantic Similarity](./homework/03_semanticSimilarity.ipynb) | BQ Corpus + PAWS-X (中文) + 优化模型 |
