...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 00 | 预习 | 2021.06.01 | 周二 | [1.NLP初体验]()<br />[2.PaddlePaddle快速入门]()<br />[3.Notebook基础操作]()<br />[4.什么是深度学习]()<br />[5.Python基础]() | UNK | UNK | [本地安装paddlepaddle](./homework/0_预习作业_本地安装paddlepaddle.md) | UNK |
