...
| 04 | 基础 | 2021.06.10 | 周四 | [词法分析技术及其应用]() | [快递单信息识别]() | UNK | [NER](./homework/04_ner.ipynb) | [1.基于BiGRU+CRF的快递单信息抽取]()<br/>[2.CRF]() |
| 05 | 理解 | 2021.06.11 | 周五 | [信息抽取技术及应用]() | [实体关系抽取]() | UNK | [ERE](./homework/05_ere.ipynb) | [尝试更多的预训练模型]() |
